...
def export_all_to_json():
    with app.app_context():
        ...
        for user in users:
            ...
            with open('kullanicilar_ve_urunler.json', 'w', encoding='utf-8') as file:
                 json.dump(data, file, ensure_ascii=False, indent=4)

        print("Veriler başarıyla kullanicilar_ve_urunler.json dosyasına kaydedildi!!!!!!!!")
